...
case "$MODE" in
    asan)     BINARY="$REPO_ROOT/out/linux-asan/amulets-armor" ;;
    release)  BINARY="$REPO_ROOT/out/linux-release/amulets-armor" ;;
    debug|*)  BINARY="$REPO_ROOT/out/linux/amulets-armor" ;;
esac
